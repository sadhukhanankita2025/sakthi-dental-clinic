      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-teal-500 p-0.5 shadow-md shadow-purple-500/20 group-hover:scale-105 transition-transform duration-300">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <motion.button
                ...
                className="px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-600 text-white font-bold text-xs tracking-wider uppercase shadow-lg shadow-purple-500/20 flex items-center gap-2 cursor-pointer hover:shadow-xl transition-all"
              >
            ...
            <div className="rounded-3xl bg-white/95 backdrop-blur-2xl border border-purple-100 p-6 shadow-2xl space-y-4">
              ...
              <div className="pt-4 border-t border-purple-100 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-teal-600 text-white font-bold text-xs uppercase tracking-wider shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 cursor-pointer"
                >
                  <Calendar className="w-4 h-4" />
