...
export default function WhyChooseUs() {
  return (
    <section className="py-28 bg-linear-to-b from-[#FAF5FF] via-purple-50/40 to-indigo-50/30 text-slate-900 relative overflow-hidden">
      {/* Soft Decorative Lavender Glow Spheres */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          >
            We combine 3D robotic accuracy, gentle painless protocols, and 20+
            years of clinical mastery in a soothing, kid-friendly hospital
            environment.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          {/* Card 1: Featured Complete Dental Ecosystem */}
          <motion.div
          ...
          <motion.div
            ...
            transition={{ delay: 0.2 }}
            whileHover={{ y: -6 }}
            className="md:col-span-5 group relative rounded-4xl overflow-hidden border border-teal-100 bg-linear-to-br from-white via-teal-50/30 to-emerald-50/50 p-8 flex flex-col justify-between h-90 shadow-xl shadow-teal-900/5 hover:shadow-2xl hover:border-teal-300/60 transition-all duration-500"
          >
            {/* Top Bar */}
            <div className="relative z-10 flex items-center justify-between">
              <span className="px-3.5 py-1.5 rounded-full bg-teal-100/80 border border-teal-200/80 text-teal-800 text-[11px] font-extrabold uppercase tracking-wider">
                100% Pain-Free Protocol
              </span>

              <div className="w-10 h-10 rounded-2xl bg-teal-100/80 border border-teal-200/80 flex items-center justify-center text-teal-700">
            ...
            <div className="relative z-10 space-y-3">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-white border border-teal-200 text-teal-800 text-xs font-bold shadow-sm">
                <Zap className="w-4 h-4 text-teal-600" />
                Computer-Assisted Anesthesia
              </div>

              <h3 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight group-hover:text-teal-700 transition-colors">
