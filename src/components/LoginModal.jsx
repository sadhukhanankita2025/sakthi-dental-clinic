...
export default function LoginModal({ isOpen, onClose, onLoginSuccess }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const mockUser = {
      name: isSignUp ? formData.name : "Saravan Selvan",
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          {/* TAB SWITCHER */}
          <div className="mb-6 flex rounded-full bg-purple-50/80 p-1 border border-purple-100/50">
            <button
              type="button"
          ...
          <p className="mt-5 text-center text-[11px] text-slate-400">
            Protected by Sakthi Dental Clinic secure verification.
          </p>
        </motion.div>
      </div>
    </AnimatePresence>
