  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="group relative h-90 sm:h-95 rounded-4xl overflow-hidden cursor-pointer border border-purple-100 hover:border-purple-300 shadow-md hover:shadow-2xl hover:shadow-purple-500/15 transition-all duration-500 bg-slate-900 flex flex-col justify-between"
      >
        {/* =================================================
            BACKGROUND IMAGE
        ================================================== */}
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-slate-950/60 to-black/30 group-hover:via-slate-950/70 transition-colors duration-300" />
        </div>
        ...
        {modalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl rounded-4xl bg-white shadow-2xl overflow-hidden z-10 border border-purple-100 my-auto max-h-[90vh] flex flex-col"
            >
              ...
              <div className="p-6 sm:p-8 overflow-y-auto space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3 pt-2 text-center text-xs">
                  ...
                  <div className="p-4 rounded-2xl bg-purple-50/80 border border-purple-100">
                    ...
                    <span className="text-purple-400 block text-[10px] uppercase font-extrabold">
                      Duration
                    </span>
                  ...
                  <div className="p-4 rounded-2xl bg-indigo-50/80 border border-indigo-100">
                    ...
                    <span className="text-indigo-400 block text-[10px] uppercase font-extrabold">
                      Recovery
                    </span>
                  ...
                  <div className="p-4 rounded-2xl bg-teal-50/80 border border-teal-100">
                    ...
                    <span className="text-teal-500 block text-[10px] uppercase font-extrabold">
                      Estimate
                    </span>
              ...
              <div className="p-6 bg-purple-50/30 border-t border-purple-100 flex flex-col sm:flex-row items-center gap-3 shrink-0">
                ...
                <button
                  ...
                  className="w-full sm:flex-1 py-3.5 px-6 rounded-2xl bg-linear-to-r from-purple-600 via-indigo-600 to-teal-600 text-white font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-purple-500/25 hover:shadow-xl transition-all cursor-pointer flex items-center justify-center gap-2"
                >
