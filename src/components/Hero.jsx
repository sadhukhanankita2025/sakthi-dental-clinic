...
import { Calendar, PhoneCall, Sparkles, Award, ShieldCheck, Heart, Star, UserCheck } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.15]">
              ...
              <span className="text-gradient">Women, Children</span> & Families
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <motion.button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-[#0D9488] via-[#0284C7] to-[#059669] text-white font-bold text-sm tracking-wider uppercase shadow-xl shadow-[#0D9488]/30 flex items-center justify-center gap-2.5 cursor-pointer"
              >
          ...
          {/* Right Column: Large Happy Family Illustration & Floating Cards */}
          <motion.div
          ...
          >
            ...
            <div className="relative w-full max-w-md lg:max-w-none rounded-[32px] overflow-hidden p-3 bg-white/60 backdrop-blur-xl border border-white/80 shadow-2xl">
              ...
              {/* Overlay Gradient */}
              <div className="absolute inset-0 rounded-[32px] bg-gradient-to-t from-slate-950/40 via-transparent to-transparent pointer-events-none" />
            </div>
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-4 sm:-left-8 glass-card p-3.5 flex items-center gap-3 shadow-xl max-w-[220px] hidden sm:flex"
            >
              <div className="w-11 h-11 rounded-full bg-[#0D9488]/10 flex items-center justify-center text-[#0D9488] shrink-0">
                <UserCheck className="w-6 h-6" />
              </div>
              <div>
                <p className="text-xs font-bold text-slate-900">Dr. Sakthi Saravanan</p>
                <p className="text-[10px] text-slate-500 font-medium">Chief Implantologist</p>
              </div>
            </motion.div>

            {/* Floating Card 2: 20+ Years Experience */}
            <motion.div
              animate={{ y: [8, -8, 8] }}
              transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
              className="absolute top-1/2 -right-4 sm:-right-8 glass-card p-3.5 flex items-center gap-3 shadow-xl max-w-[210px]"
            >
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#0D9488] to-[#0284C7] text-white flex items-center justify-center shrink-0 shadow-md">
                <Award className="w-5 h-5" />
              </div>
              <div>
                <p className="text-xs font-bold text-slate-900">20+ Years Exp.</p>
                <p className="text-[10px] text-slate-500 font-medium">Top Dental Surgeons</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <p className="text-xs font-bold text-slate-900">24/7 Pain Relief</p>
                <p className="text-[10px] text-emerald-600 font-semibold">Instant Emergency Care</p>
              </div>
            </motion.div>
